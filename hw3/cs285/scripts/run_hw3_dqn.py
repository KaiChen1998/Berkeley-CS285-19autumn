...
class Q_Trainer(object):
    ...
    def __init__(self, params):
        ...
        train_args = {
            ...
            'train_batch_size': params['batch_size'], # train batch size
            'double_q': params['double_q'],
        }

        env_args = get_env_kwargs(params['env_name']) # 针对不同的env有不同的参数
...
def main():
    ...
    parser.add_argument('--num_agent_train_steps_per_iter', type=int, default=1) # 一个agent step代表sample一次数据
    parser.add_argument('--num_critic_updates_per_agent_update', type=int, default=1) # 就是slide中的K，即sample one batch之后更新多少次
    ...
    parser.add_argument('--use_polyak', action='store_true')
