...
def main():
    ...
    parser.add_argument('--ensemble_size', '-e', type=int, default=3) # model个数
    parser.add_argument('--mpc_horizon', type=int, default=10) # 每个action sequence的时长
    parser.add_argument('--mpc_num_action_sequences', type=int, default=1000) # random shooting的采样个数
