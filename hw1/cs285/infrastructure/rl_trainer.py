...
class RL_Trainer(object):
    ...
    def __init__(self, params):
        ...
        self.params['ep_len'] = self.params['ep_len'] or self.env.spec.max_episode_steps # 若无定义就用默认值
        ...
        self.agent = agent_class(self.sess, self.env, self.params['agent_params']) # 只在这里建了agent的tf graph
        self.learning_curve = []
    ...
    def run_training_loop(self, n_iter, collect_policy, eval_policy,
        ...
        np.save(os.path.join(self.params['logdir'], 'learning_curve.npy'), np.array(self.learning_curve))
    ...
    def train_agent(self):
        ...
        for train_step in range(self.params['num_agent_train_steps_per_iter']):
            ...
            print('\nBatch {}: loss: {}'.format(train_step, self.agent.actor.batch_loss))
    ...
    def perform_logging(self, itr, paths, eval_policy, train_video_paths):
        ...
        if self.log_metrics:
            ...
            print('Performance: {}'.format(np.mean(eval_returns) / self.initial_return))
            print('Done logging...\n\n')
