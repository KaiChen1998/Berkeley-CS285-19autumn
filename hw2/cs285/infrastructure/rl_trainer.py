...
class RL_Trainer(object):
    ...
    def run_training_loop(self, n_iter, collect_policy, eval_policy,
        ...
        np.save(os.path.join(self.params['logdir'], self.params['exp_name'] + '.npy'), np.array(self.learning_curve))
    ...
    def train_agent(self):
        ...
        for train_step in range(self.params['num_agent_train_steps_per_iter']):
            ...
            batch_loss = self.agent.train(ob_batch, ac_batch, re_batch, next_ob_batch, terminal_batch)
